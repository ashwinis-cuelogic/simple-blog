...
<body>
                ...
                if (true == isset($this->session->userdata["first_name"])){ ?>
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li>
                         ...
                         <li>
                         <a href="<?php echo $this->config->base_url(); ?>index.php/blog/index/<?php echo $blogs[0]->blog_category_id; ?>">blogs</a>
                        </li>
                    </ul>
                <?php } else { ?>
                    <p>Welcome Guest</p>
    ...
    <header class="intro-header" style="background-image: url('http://localhost/Project/simple-blog/themes/img/post-bg.jpg')">
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                    <div class="post-heading">
                        <h1><?php echo $blogs[0]->title ?></h1>
                        <span class="meta"> Posted by <?php echo $blogs[0]->first_name; echo " "; echo $blogs[0]->last_name; ?></span>
                    </div>
                </div>
            </div>
        </div>
