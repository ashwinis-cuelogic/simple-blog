                ...
                if (true == isset($this->session->userdata["first_name"])){ ?>
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li>
                          ...
                          <li>
                            <a href="<?php echo $this->config->base_url(); ?>index.php/category">Blog</a>
                        </li>
                    </ul>
                <?php } else { ?>
                    <p>Welcome Guest</p>
            ...
            <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                <?php foreach ($blogs as $blog) {?>
                 <div class="post-preview">
                    ...
                    <p class="post-meta">Posted by <?php echo $blog->first_name; echo " "; echo $blog->last_name; ?> on September 24, 2014</p>
                </div>
                <hr>
                <?php } ?>
              </div>
